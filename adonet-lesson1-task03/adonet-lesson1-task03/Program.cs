...
namespace AdoNetLibraryApp
{
    class Program
    {
        // Измените эти параметры для вашего сервера SQL Server
        private const string ServerName = "localhost\\SQLEXPRESS"; // или просто "localhost"
        private const string DatabaseName = "Library";
        private const string UserName = ""; // оставьте пустым для Windows-аутентификации
        private const string Password = ""; // оставьте пустым для Windows-аутентификации
        private readonly string connectionString;
//Server=localhost\SQLEXPRESS;Database=master;Trusted_Connection=True;
        public Program()
        {
            // Формируем строку подключения в зависимости от типа аутентификации
